...
require_once 'TableEntry.php';
require_once 'Tables.php';
require_once 'Messages.php';
require_once 'Dictionary.php';
require_once 'Collection.php';
require_once 'EntityStates.php';
require_once 'Entity.php';
require_once 'ResourceBox.php';
require_once 'RelatedEnd.php';
require_once 'SaveResult.php';
require_once 'Guid.php';
require_once 'ClientType.php';
require_once 'ACSUtil.php';
require_once 'AzureTableUtil.php';
require_once 'ContentType.php';
require_once 'CredentialType.php';
require_once 'CredentialBase.php';
require_once 'AzureTableCredential.php';
require_once 'ACSCredential.php';
require_once 'WindowsCredential.php';
require_once 'Utility.php';
require_once 'DataServiceQueryContinuation.php';
require_once 'QueryComponents.php';
require_once 'QueryOperationResponse.php';
require_once 'DataServiceQuery.php';
require_once 'DataServiceStreamResponse.php';
require_once 'DataServiceRequestArgs.php';
require_once 'SaveChangesOptions.php';
require_once 'DataServiceSaveStream.php';
require_once 'ContentStream.php';
require_once 'DataServiceResponse.php';
require_once 'OperationResponse.php';
require_once 'AtomParser.php';
require_once 'HttpBatchRequest.php';
require_once 'HttpBatchResponse.php';
require_once 'HttpRequest.php';
require_once 'Microsoft_Http_Responset.php';
require_once 'HttpResponse.php';
require_once 'HttpRequestHeader.php';
require_once 'HttpVerb.php';
require_once 'HttpProxy.php';
require_once 'ODataServiceException.php';
require_once 'DataServiceRequestException.php';
require_once 'InvalidOperation.php';
require_once 'ACSUtilException.php';
...
class ObjectContext
{
                                             ...
                                             &$isError, &$innerException)
    {
        ...
        catch(InvalidOperation $exception)
        {
            ...
            return new Microsoft_Http_Responset('404', array());
        }
